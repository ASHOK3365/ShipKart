...
import { allElectronicsProducts } from '@/data/electronicsData';
...
const ElectronicsPage = () => {
  ...
  const filteredProducts = useMemo(() => {
    if (activeTab === 'All') return allElectronicsProducts;
    return allElectronicsProducts.filter(p => p.subCategory === activeTab);
  }, [activeTab]);
        ...
        <header className={styles.header}>
          <div className={styles.headerLeft}>
            <div className={styles.headerIcon}>
              <MonitorSpeaker size={32} color="#7C3AED" />
            </div>
            <div>
              <h1>Premium Electronics</h1>
              <p>Explore cutting-edge tech and gadgets.</p>
            </div>
          </div>
        ...
        <div className={styles.cartList}>
          ...
          {items.length === 0 && (
            <div className={styles.emptyCart}>
              <ShoppingBag size={48} opacity={0.2} color="#7C3AED" />
